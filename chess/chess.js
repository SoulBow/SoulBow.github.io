const aking=document.getElementById("king");
const aqueen=document.getElementById("queen");
const arook=document.getElementById("rook");
const abishop=document.getElementById("bishop");
const aknight=document.getElementById("knight");
const apawn=document.getElementById("pawn");
...
function graveYard() {
if (node.style.background=="black")
...
aking.style.background="";
aqueen.style.background="";
arook.style.background="";
abishop.style.background="";
aknight.style.background="";
apawn.style.background="";}}
...
function aselectKing() {
if
(aking.style.background=="yellow") 
{aking.style.background="";}
else  {
aking.style.background="yellow";
aking.style.border="solid 1px";
aqueen.style.background="";
arook.style.background="";
abishop.style.background="";
aknight.style.background="";
...
function aselectQueen() {
if
(aqueen.style.background=="yellow") 
{aqueen.style.background="";}
else {
aqueen.style.background="yellow";
aqueen.style.border="solid 1px";
aking.style.background="";
arook.style.background="";
abishop.style.background="";
aknight.style.background="";
...
function aselectRook() {
if
(arook.style.background=="yellow") 
{arook.style.background="";}
else {
arook.style.background="yellow";
arook.style.border="solid 1px";
aking.style.background="";
aqueen.style.background="";
abishop.style.background="";
aknight.style.background="";
...
function aselectBishop() {
if
(abishop.style.background=="yellow") 
{abishop.style.background="";}
else {
abishop.style.background="yellow";
abishop.style.border="solid 1px";
aking.style.background="";
aqueen .style.background="";
arook.style.background="";
aknight.style.background="";
...
function aselectKnight() {
if
(aknight.style.background=="yellow") 
{aknight.style.background="";}
else {
aknight.style.background="yellow";
aknight.style.border="solid 1px";
aking.style.background="";
aqueen.style.background="";
arook.style.background="";
abishop.style.background="";
...
function aselectPawn() {
if
(apawn.style.background=="yellow") 
{apawn.style.background="";}
else {
apawn.style.background="yellow";
apawn.style.border="solid 1px";
aking.style.background="";
aqueen.style.background="";
arook.style.background="";
abishop.style.background="";
...
element.style.color="blue";
element.style.width="100%";}
else if (element.style.background=="" && node.style.background=="black") {node.style.background="white";
element.innerHTML=". . . . . . . . . . . . . .";}
else if (element.style.background=="" && node.style.background=="white")
{node.style.background="black";
element.innerHTML=". . . . . . . . . . . . . .";}}
function boardSet() {
